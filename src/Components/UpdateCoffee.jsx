...
const UpdateCoffee = () => {
    ...
    const {_id, name, quantity, supllier, test, category, detail, photo, }= loadedCoffee;
    ...
    return (
        <div>
          <h1 className='text-center text-6xl font-extrabold m-5'>update coffe of {name}</h1>
                ...
                <div className='bg-[#F4F3F0] p-24'>
                    ...
                    <div className='flex gap-10 container justify-center mb-8 '>
                        <div className="form-control md:w-1/2">
                            ...
                            <label className="input-group ">
                                <input type="text" name='supllier' defaultValue={supllier} placeholder="enter coffee supllier" className="input w-full input-bordered" />
                            </label>
                        </div>
                        <div className="form-control md:w-1/2">
                            <label className="label">
                            ...
                            <label className="input-group">
                                <input type="text" name="test" defaultValue={test} placeholder="enter coffee test" className="input w-full input-bordered" />
                            </label>
                        </div>
                    ...
                    <div className='flex gap-10 container justify-center mb-8 '>
                        <div className="form-control md:w-1/2">
                            ...
                            <label className="input-group ">
                                <input type="text" name="category"  defaultValue={category} placeholder="enter coffee category" className="input w-full input-bordered" />
                            </label>
                        </div>
                        <div className="form-control md:w-1/2">
                            <label className="label">
                            ...
                            <label className="input-group">
                                <input type="text" name="detail" defaultValue={detail} placeholder="enter coffe detail" className="input w-full input-bordered" />
                            </label>
                        </div>
